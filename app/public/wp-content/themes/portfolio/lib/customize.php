...
function _themename_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting('_themename_header_colour', array(
        'default'=> '#222222',
        'transport' => 'postMessage',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, '_themename_header_colour',
        array(
    ...
    $wp_customize->add_setting('_themename_site_info', array(
        'default' => '',
        'sanitze_callback' => '_themename_sanitize_site_info',
        'transport' => 'postMessage'
    ));
